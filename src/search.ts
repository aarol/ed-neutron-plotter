...
export class SearchBox {
  ...
  private gpsIcon: HTMLDivElement;
  ...
  constructor(options: SearchBoxOptions) {
    ...
    // Create GPS journal icon
    this.gpsIcon = document.createElement('div');
    this.gpsIcon.className = styles.gpsIcon;
    this.gpsIcon.title = 'Track in-game location';
    this.gpsIcon.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8"/><line x1="12" y1="2" x2="12" y2="5"/><line x1="12" y1="19" x2="12" y2="22"/><line x1="2" y1="12" x2="5" y2="12"/><line x1="19" y1="12" x2="22" y2="12"/><circle cx="12" cy="12" r="3"/></svg>`;

    this.gpsIcon.addEventListener('click', () => {
    ...
    this.container.appendChild(this.gpsIcon);
  }
