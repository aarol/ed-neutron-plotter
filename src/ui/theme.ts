export const uiTheme = {
  glassPanel:
    "border border-white/30 bg-[linear-gradient(135deg,rgba(11,16,32,0.95),rgba(26,35,56,0.92))] text-space-text shadow-[0_12px_40px_rgba(0,0,0,0.6)] backdrop-blur-xl",
  ...
  textInput:
    "border border-white/30 bg-black/70 px-5 py-3 pr-11 text-base text-white shadow-[0_4px_15px_rgba(0,0,0,0.2)] outline-none backdrop-blur-md transition placeholder:text-white/50 focus:border-white/60 focus:bg-black/80 focus:shadow-[0_6px_20px_rgba(0,0,0,0.3)]",
  compactInput:
